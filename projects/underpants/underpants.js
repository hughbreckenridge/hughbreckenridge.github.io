...
_.filter = function(array, func) {
    ...
    for(let i = 0; i < array.length; i++) {
        if (func(array[i], i, array)) filteredArr.push(array[i]);
    }
    return filteredArr;
};
...
_.reject = function(array, func) {
    var rejectArr = [];
    for(let i = 0; i < array.length; i++) {
        if (!func(array[i], i, array)) rejectArr.push(array[i]);
    }
    return rejectArr;
};
...
_.partition = function(array, func) {
    ...
    var partiton2Arr = [];
    for(let i = 0; i < array.length; i++) {
        if (func(array[i], i, array)) partitionArr.push(array[i]);
        if (!func(array[i], i, array)) partiton2Arr.push(array[i]);
    }
    return [partitionArr, partiton2Arr];
